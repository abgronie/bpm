 ...
 <div type="subtable" readonly="readonly" tablename="${subTable.tableName}" tableDesc="${subTable.tableDesc}" ng-if="!permission.table.${toLower(subTable.tableName)}.hidden">
	...
	<div class="am-scrollable-horizontal">
        <table class="am-table am-table-bordered am-table-striped am-text-nowrap">
			...
			<#else>
			 ...
			 <tr ng-repeat="item in data.sub.${subTable.tableName}.rows">
			 <#if teamFields??>
				<#if isShow>
					<#if showPosition == 1>
