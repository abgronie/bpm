			...
			<table cellpadding="1" cellspacing="1" class="table-grid table-list">
				...
				<tr class="<#noparse><#if data_index % 2 == 0>odd</#if><#if data_index % 2 == 1>even</#if></#noparse>">
					...
					<td>
						...
						<a href="${ctxPath}/platform/form/bpmFormHandler/bizForm.ht?formKey=${formKey}&id=<#noparse>${data.</#noparse>${pkField}}" class="link edit">编辑</a>
						<a href="${ctxPath}/platform/form/bpmFormHandler/del.ht?formKey=${formKey}&id=<#noparse>${data.</#noparse>${pkField}}" class="link del">删除</a>
					</td>
				</tr>
