...
public class WeixinConsts {
	...
	public static String getWxToken(){
		...
		String secret=PropertyUtil.getByAlias("corpsecret");
	...
	public static String getToKen(){
		String corpId=PropertyUtil.getByAlias("corpid");
		String secret=PropertyUtil.getByAlias("agentSecret");
		return QIYE_URL + "/gettoken?corpid=" + corpId + "&corpsecret=" + secret;
	}
	...
	public static String getWxAuthorize(String redirectUrl) throws UnsupportedEncodingException{
		String corpId=PropertyUtil.getByAlias("corpid");
		String agentid=PropertyUtil.getByAlias("agentid");
	...
	public static String getDepartmentUrl(String department_id) {
		String url =QIYE_URL +"/user/simplelist?access_token="+TokenUtil.getWxToken()+"&department_id="+department_id;
		return url;
	}
