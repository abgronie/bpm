...
public interface FlowService {
	 ...
	 * @since 1.0.0
	 */
	String getPendingMattersListForMh(@WebParam(name = "account") String account, @WebParam(name = "currentPage") String currentPage, @WebParam(name = "pageSize") String pageSize);
	/**
	 * 获取指定account用户的已办事宜
	 * 2018-03-01 周亮
	 * @param account
	 ...
	 * @since 1.0.0
	 */
	String getAlreadyMattersListJsonForMh(@WebParam(name = "account") String account, @WebParam(name = "currentPage") String currentPage, @WebParam(name = "pageSize") String pageSize);
	/**
	 * 获取指定account用户的办结事宜
	 * 2018-03-01 周亮
	 * @param account
	 ...
	 * @since 1.0.0
	 */
	String getMyCompletedListJsonForMh(@WebParam(name = "account") String account, @WebParam(name = "currentPage") String currentPage, @WebParam(name = "pageSize") String pageSize);
	/**
	 * 获取指定account用户的待办事宜总数
	 * 2018-03-01 周亮
	 * @param account
	 * 		：执行人account账号
	 * @param currentPage
	 ...
	 * @since 1.0.0
	 */
	String getPendingMattersCountForMh(@WebParam(name = "account") String account);
