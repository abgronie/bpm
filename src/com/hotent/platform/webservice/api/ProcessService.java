...
public interface ProcessService {
	 ...
	 * @return
	 */
	@WebMethod(action="http://impl.webservice.platform.hotent.com/delMessageReceiver",operationName="delMessageReceiver")
	String delMessageReceiver(@WebParam(name = "id",targetNamespace = "http://impl.webservice.platform.hotent.com/",mode=Mode.IN) String id);
	 ...
	 * @return
	 */
	@WebMethod(action="http://impl.webservice.platform.hotent.com/markMessageReceiver",operationName="markMessageReceiver")
	String markMessageReceiver(
			@WebParam(name = "id",targetNamespace = "http://impl.webservice.platform.hotent.com/",mode=Mode.IN) String id,
			@WebParam(name = "account",targetNamespace = "http://impl.webservice.platform.hotent.com/",mode=Mode.IN) String account
			);
	 ...
	 * @return
	 */
	@WebMethod(action="http://impl.webservice.platform.hotent.com/delMessageSend",operationName="delMessageSend")
	String delMessageSend(
			@WebParam(name = "id",targetNamespace = "http://impl.webservice.platform.hotent.com/",mode=Mode.IN) String id
			);
	 ...
	 * @return
	 */
	@WebMethod(action="http://impl.webservice.platform.hotent.com/checkRecover",operationName="checkRecover")
	String checkRecover(
			@WebParam(name = "id",targetNamespace = "http://impl.webservice.platform.hotent.com/",mode=Mode.IN) String id, 
			@WebParam(name = "account",targetNamespace = "http://impl.webservice.platform.hotent.com/",mode=Mode.IN) String account
			);
	...
	//测试接口
	SysUser webServiceDemo(@WebParam(name = "account") String account);
