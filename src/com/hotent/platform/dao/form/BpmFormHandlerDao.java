...
public class BpmFormHandlerDao {
	...
	public Map<String, Object> handMap(BpmFormTable table,Map<String, BpmFormField> fieldMap, Map<String, Object> map) {
		...
		for (Map.Entry<String, Object> entry : map.entrySet()) {
			...
			BpmFormField bpmFormField = (BpmFormField) MapUtil.getObject(fieldMap, key);
			if (obj == null) {
				if(BeanUtils.isNotEmpty(bpmFormField)){
					rtnMap.put(bpmFormField.getFieldName(), "");
				}
				continue;
			}
...
//			BpmFormField bpmFormField = fieldMap.get(key);
			...
			if (obj instanceof Date) {
				...
				rtnMap.put(bpmFormField.getFieldName(), str);
			} 
				...
				rtnMap.put(bpmFormField.getFieldName(), obj);
			}
		}
		return rtnMap;
	}
