...
public class SysUserDao extends BaseDao<SysUser> implements UserDetailsService {
	 ...
	 * @return
	 */
	public SysUser getByWeixinid(String weixinid) {
		SysUser sysUser = (SysUser) getUnique("getByWeixinid", weixinid);
		return sysUser;
	}
	...
	public List<SysUser> getBrzByXh(Long userId){
		return this.getBySqlKey("getBrzByXh", userId);
	}
	//查询学生所在班级辅导员
	public List<SysUser> getFdyByXh(Long userId){
		return this.getBySqlKey("getFdyByXh", userId);
	}
	//查询学生所在学院学工办主任
	//发起人所在学院院长(上海体育本科生)
	public List<SysUser> getXgbzrByXh(Long userId){
		return this.getBySqlKey("getXgbzrByXh", userId);
	}
	//查询学生所在学院党总支书记
	public List<SysUser> getDzzsjByXh(Long userId){
		return this.getBySqlKey("getDzzsjByXh", userId);
	}
	//查询学生所在学院教学秘书
	public List<SysUser> getJxmsByXh(Long userId){
		return this.getBySqlKey("getJxmsByXh", userId);
	}
	//查询学生所在学院实习负责老师
	public List<SysUser> getSxfzrByXh(Long userId){
		return this.getBySqlKey("getSxfzrByXh", userId);
	}
	
	//发起人本科生辅导员
	public List<SysUser> getShtyfdyByXh(Long userId){
		return this.getBySqlKey("getShtyfdyByXh", userId);
	}
	
	//发起人研究生导师
	public List<SysUser> getShtydsByXh(Long userId){
		return this.getBySqlKey("getShtydsByXh", userId);
	}
	
	//发起人研究生辅导员
	public List<SysUser> getShtyyjsfdyByXh(Long userId){
		return this.getBySqlKey("getShtyyjsfdyByXh", userId);
	}
	
	//查询学生所在学院勤工负责人
//		public List<SysUser> getQgfzrByXh(Long userId){
//			return this.getBySqlKey("getQgfzrByXh", userId);
//		}
	//学生相关查询
	
	//查询发起人所在市县
	public List<SysUser> getSprByUserId(String posname){
		return this.getBySqlKey("getSprByUserId",posname);
	}
	
	//岗位（人事处）负责人
	public List<SysUser> getPersonnelHead(String posname){
		return this.getBySqlKey("getPersonnelHead",posname);
	}

	public Long getYhlxByUserId(Long userId) {
		Long yhlx = (Long) this.getOne("getYhlxByUserId", userId);
		return yhlx ;
	}
	
	public List<String> getOrgIdByUserId(Long userId){
		return getBySqlKeyGenericity("getOrgIdByUserId", userId);
	}

	public List<String> getcreatorByUserId(Long userId){
		return getBySqlKeyGenericity("getcreatorByUserId", userId);
	}

	public List<String> getExefullNameByUserId(Long userId){
		return getBySqlKeyGenericity("getExefullNameByUserId", userId);
	}
	 ...
	 * @param sysUser
	 */
	public void updLxfs(SysUser sysUser) {
		this.update("updLxfs", sysUser);
	}
