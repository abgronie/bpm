...
public class ProcessRun extends BaseModel implements Cloneable, IProcessRun {
    ...
    //发起流量总数
    private String launchProcessesTotal;

    //已办结数
    private String processesOperationsTotal;
    ...
    public String getLaunchProcessesTotal() {
        return launchProcessesTotal;
    }

    public void setLaunchProcessesTotal(String launchProcessesTotal) {
        this.launchProcessesTotal = launchProcessesTotal;
    }

    public String getProcessesOperationsTotal() {
        return processesOperationsTotal;
    }

    public void setProcessesOperationsTotal(String processesOperationsTotal) {
        this.processesOperationsTotal = processesOperationsTotal;
    }
	...
	public void setTimeOutTotal(String timeOutTotal) {
