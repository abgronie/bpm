...
public class ResourcesService extends BaseService<Resources>
{
	...
	public List<Resources> getBySystemIdAndParentId(long systemId, Long parentId) {
		return resourcesDao.getBySystemIdAndParentId(systemId, parentId);
	}

	public boolean hasSysPro(Long systemId, Long userId, String sysProAlias) {
		return resourcesDao.hasSysPro(systemId,userId,sysProAlias);
	}
