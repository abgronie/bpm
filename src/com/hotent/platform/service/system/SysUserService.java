...
//		return userList;
	 ...
	 * @return
	 */
	public List<SysUser> getUserByUserName(QueryFilter queryFilter) {
		return dao.getBySqlKey("getUserByUserName", queryFilter);
	}
	...
	public List<String> getOrgIdByUserId(Long userId) {
		List<String> sysUserId = dao.getOrgIdByUserId(userId);
		return  sysUserId;
	}
	...
	public List<String> getcreatorByUserId(Long userId) {
		List<String> sysUserId = dao.getcreatorByUserId(userId);
		return  sysUserId;
	}
	...
	public List<String> getExefullNameByUserId(Long userId) {
		List<String> sysUserId = dao.getExefullNameByUserId(userId);
		return  sysUserId;
	}
