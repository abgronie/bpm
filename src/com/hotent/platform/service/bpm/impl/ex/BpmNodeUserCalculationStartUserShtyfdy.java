 ...
 * 
 * 发起人本科生辅导员
 *com.hotent.platform.service.bpm.impl.ex.BpmNodeUserCalculationStartUserShtyfdy
 */
public class BpmNodeUserCalculationStartUserShtyfdy implements IBpmNodeUserCalculation {
	...
	public List<SysUser> getExecutor(BpmNodeUser bpmNodeUser, CalcVars vars) {
		...
		list = stuSysUserService.getShtyfdyByXh(startUserId);
