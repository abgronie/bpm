 ...
 * 
 * 发起人研究生导师
 *com.hotent.platform.service.bpm.impl.ex.BpmNodeUserCalculationStartUserShtyds
 */
public class BpmNodeUserCalculationStartUserShtyds implements IBpmNodeUserCalculation {
	...
	public List<SysUser> getExecutor(BpmNodeUser bpmNodeUser, CalcVars vars) {
		...
		list = stuSysUserService.getShtydsByXh(startUserId);
