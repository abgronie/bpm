 ...
 */
public class BpmNodeUserCalculationStartUserXgbzr implements IBpmNodeUserCalculation {
	...
	public List<SysUser> getExecutor(BpmNodeUser bpmNodeUser, CalcVars vars) {
		...
		list = stuSysUserService.getXgbzrByXh(startUserId);
