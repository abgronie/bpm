 ...
 * 
 * 发起人研究生辅导员
 *com.hotent.platform.service.bpm.impl.ex.BpmNodeUserCalculationStartUserShtyyjsfdy
 */
public class BpmNodeUserCalculationStartUserShtyyjsfdy implements IBpmNodeUserCalculation {
	...
	public List<SysUser> getExecutor(BpmNodeUser bpmNodeUser, CalcVars vars) {
		...
		list = stuSysUserService.getShtyyjsfdyByXh(startUserId);
