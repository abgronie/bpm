...
public class MainController extends BaseController {
	...
	public ModelAndView main(HttpServletRequest request,
		...
		Long uiStyleId = SysPropertyService.getIdByAlias("UI_STYLE");
		// 添加内容
		String mainViewName = "main";
		if("default".equals(uiStyle)){
			mainViewName = "main";
		}else if("extendIndex".equals(uiStyle)){
			mainViewName = "mainExtendIndex";
		}else if("defaultOld".equals(uiStyle)){
			mainViewName = "mainOld";
		}
		//前系统有系统
		...
		// 由于切换主页风格属于系统属性，现在只允许超级管理员，或者该用户的角色有系统属性操作权限才能更换
		// 这个是系统属性的别名
		String sysProAlias = "xtsx";
		//boolean hasSysPro = resourcesService.hasSysPro(currentSystem.getSystemId(),curUser.getUserId(),sysProAlias);
		boolean isAllow = false;
		/*if(curUser.getAccount().equals(SysUser.getAdminAccount()) || hasSysPro){
			isAllow = true;
		}*/
		return this.getView("console",mainViewName)
			.addObject("skinStyle",skinStyle)
			.addObject("currentUser", curUser)
			.addObject("isAllow", isAllow)
