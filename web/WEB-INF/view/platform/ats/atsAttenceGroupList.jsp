...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="atsAttenceGroupList" id="atsAttenceGroupItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${atsAttenceGroupItem.id}">
				</display:column>
				...
				<display:column title="管理" media="html"  class="rowOps">
					<a href="del.ht?id=${atsAttenceGroupItem.id}" class="link del">删除</a>
					<a href="edit.ht?id=${atsAttenceGroupItem.id}" class="link edit">编辑</a>
				</display:column>
			</display:table>
			<hotent:paging tableId="atsAttenceGroupItem"/>
