...
<body>
	...
	<div  class="panel-top">
		<div class="panel-search">
			<form id="searchForm" method="post" action="${ctx}/platform/ats/atsCalendarTempl/selector.ht" >
				<ul class="row">
	...
	<display:table  name="atsCalendarTemplList" id="atsCalendarTemplItem" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
		<display:column title="选择" media="html" style="width:30px;">
			<input type="radio" class="pk" name="data" value="${atsCalendarTemplItem.id}#${atsCalendarTemplItem.name}">
		</display:column>
	...
	<hotent:paging tableId="atsCalendarTemplItem" showExplain="false"/>
</body>
</html>
