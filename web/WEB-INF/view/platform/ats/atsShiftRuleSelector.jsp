...
<body>
	...
	<div  class="panel-top">
		<div class="panel-search">
			<form id="searchForm" method="post" action="${ctx}/platform/ats/atsShiftRule/selector.ht" >
				<ul class="row">
	    ...
	    <display:table name="atsShiftRuleList" id="atsShiftRuleItem" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
		<display:column title="选择" media="html" style="width:30px;">
			<input type="radio" class="pk" name="data" value="${atsShiftRuleItem.id}#${atsShiftRuleItem.name}">
		</display:column>
	...
	<hotent:paging tableId="atsShiftRuleItem" showExplain="false"/>
</body>
</html>
