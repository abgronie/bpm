...
<body >
	...
	<script class="hidden" id="formTabTdTemplate">
	<td>
		<select class="\${data.right}_select"  permissonType="\${data.permission.#rightName.type}" name="\${data.permission.title}">
			<option value="user">用户</option>
			<option value="role">角色</option>
	...
	<script class="hidden" id="teamPermissionTemplate">
	<tr id="team">
		<th colspan="1">
			分组名称：
		</th>
		<td colspan="1">
			\${data.permission.memo}
		</td>
		<th colspan="1">
			显示权限
		</th>
		<td colspan="2" id = "teamPserssion">
			\${data.teamHtml}
		</td>
	</tr>
		\${data.fieldHtml}
	...
	<script class="hidden" id="teamTdTemplate">
