...
<script type="text/javascript">
	...
	function refreshForm() {
		var b = new Base64();   
		var html = b.encode(editor.getContent());
		//alert(html);
	    var params={formKey:$("#formKey").val(),html:html};
	    var url="${ctx}/platform/form/bpmFormDef/refreshForm.ht";
   	    $.post(url,params,function(responseText){
   		var obj=new com.hotent.form.ResultMessage(responseText);
   		//alert(obj.getMessage());
   		//$("#html").val(obj.getMessage());
   		editor.setContent(obj.getMessage());
	   });
	}
	...
	<div>
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group">
					<a class="link search" id="btnHis" href="javaScript:void(0)">
						<span></span>
						查看历史记录
					</a>
				</div>
								<div class="group">
					<a class="link reset" id="btnHis" href="javaScript:void(0)" onclick="javascript:refreshForm()">
						<span></span>
						刷新表单
					</a>
				</div>
