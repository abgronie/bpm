...
<body>
	...
	<div id="hide-panel" class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group">
						<a class="link back"><span></span>返回</a>
					</div>
					...
					<div class="group">
						<a onclick="clickAddRow()" class="link add"><span></span>添加列</a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<a id="moveupField" class="link moveup"><span></span>上移</a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<a id="movedownField" class="link movedown"><span></span>下移</a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<a id="delField" class="link del "><span></span>删除</a>
					</div>
					<c:if test="${canGenerate }">
						<div class="group generate hidden">
							<a class="link table" href="javascript:;"><span></span>生成表</a>
						</div>
					</c:if>
				</div>
			</div>
	...
	<div class="panel_tabfield">
		<form id="bpmTableForm" method="post" action="saveTable.ht">
			<div class="panel-detail" style="padding-top: 45px;">
