	...
	<script type="text/javascript">
        ...
        function nextStep(){
            ...
            var callBack=function(){
                ...
                //by byq
                $("#content").val(utf8_to_b64(objForm.form));
                $("#tabTitle").val(objForm.title);
                $("textarea[name='editorValue']").val("");
                frm.submit();
            }
            validForm(callBack);
        ...
        function preCallBack(tableName,comment,html){
            ...
            //frm.addFormEl("html",htmlDecode(objForm.form));
			//by byq
            frm.addFormEl("html",utf8_to_b64(htmlDecode(objForm.form)));
