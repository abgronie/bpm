...
<%@include file="/commons/include/form.jsp" %>
	...
	$(function(){
		...
		$("[name='importType']").on("change",function(event){
			var value = event.target.value;
			if(value == "update"){
				$(".emptyDo").removeClass("hidden");
			}else{
				$(".emptyDo").addClass("hidden");
			}
		})
	});
			 ...
			 <table id="tableid" class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td width="78%">
					             ...
					             导入删除<input type="radio" name="importType"  value="delete" />
					</td>						
				</tr>
				<tr>
					<th width="22%">标识字段：</th>
					<td width="78%">
						<input type="hidden" value="${param.importIdField}" name="importIdField"> 
						${param.importIdField}
					</td>						
				</tr>
				<tr class="emptyDo hidden">
					<th width="22%">空数据处理：</th>
					<td width="78%">
			          	 为空跳过<input type="radio" name="emptyDo"  value="ignore" />
						覆盖更新<input type="radio" checked="checked" name="emptyDo"  value="update" />
					</td>						
				</tr>
			</table>				
