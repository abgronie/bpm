	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="alreadyMattersWithSamePositionList.ht">
							<ul class="row">
		...
		<div class="panel-body">
			    ...
			    <display:table name="processRunList" id="processRunItem" requestURI="alreadyMattersWithSamePositionList.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
