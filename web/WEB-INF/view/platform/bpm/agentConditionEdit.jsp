...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" href="javascript:;"><span></span></span>确定</a></div>
				<div class="l-bar-separator"></div>
				<div class="group"><a class="link add" onclick="addAgent()" href="javascript:;"><span></span>添加</a></div>
				<div class="l-bar-separator"></div>
