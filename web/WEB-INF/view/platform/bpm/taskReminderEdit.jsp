...
<%-- 														<f:flowVar defId="${defId}" controlName="selFlowVar"></f:flowVar> --%>
						    ...
						    <div class="reminder-div-msg-sms" title="手机短信内容">
					     	...
					     	<div class="reminder-div-msg-weixin" title="微信消息">
						    	<div class="panel-detail">
								    <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
								    	<tr >
									     	<th width="60" >微信消息内容: </th>
											<td>
												<textarea id="weixinContent" name="weixinContent" rows="12" cols="50">${taskReminder.weixinContent}</textarea>
											</td>
										</tr>
									</table>
								</div>
