	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					--%>
					<div class="group"><f:a alias="delDraft" css="link del" action="delDraft.ht" showNoRight="false"><span></span>删除</f:a></div>
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="myForm.ht">
					...
					<div class="row_date">
					<li>
						<span class="label">申请时间 从:</span> <input  name="Q_begincreatetime_DL"  class="inputText date" value="${param['Q_begincreatetime_DL']}"/>
					</li>
					<li>
		...
		<div class="panel-body">
			    ...
			    <display:table name="processRunList" id="processRunItem" requestURI="myForm.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
					...
					<display:column property="creator" title="申请人" sortable="true" sortName="creator" style="text-align:left"></display:column>
