...
<html>
    <head>
        ...
        <script type="text/javascript">
    			var catKey="<%=GlobalType.CAT_FLOW%>";
     			...
     			leftClickUrl= __ctx+'/platform/bpm/processRun/alreadyMattersWithSamePositionList.ht'
         </script> 
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="center">
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/processRun/alreadyMattersWithSamePositionList.ht"></iframe>
            </div>
        </div>
    </body>
</html>
