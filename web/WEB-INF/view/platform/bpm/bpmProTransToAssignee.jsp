	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link back" href="${ctx}/platform/bpm/bpmProTransTo/mattersList.ht"><span></span><spr:message code="menu.button.back"/></a></div>
				</div>	
			</div>
		</div>
		</div>
		<div class="panel-body">
		    ...
		    <display:table name="bpmProTransToAssigneeList" id="bpmProTransToAssigneeItem" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column titleKey="流转状态" style="text-align:center;">
					<c:choose>
			...
			<hotent:paging tableId="bpmProTransToAssigneeItem" />
