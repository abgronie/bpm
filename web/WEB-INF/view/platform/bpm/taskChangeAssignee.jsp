	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveTaskAssignee(){
				...
				var informTypes = '';
				$("input[name='informType']:checked").each(function (index, item) {
					informTypes += $(this).val()+",";
				});
				//@byq informType有问题
				var params=$('#taskForm').serialize()+"&informTypes="+informTypes;
					...
					<table class="table-detail">
						...
						<tr>
							...
							<td>
								...
								<a href="javascript:;" id="jumpUserLink" class="link get" onclick="selectExeUsers('${nodeUserMap.nodeId}')">&nbsp;&nbsp;</a>
							</td>
						</tr>
						<tr>
							<th>更改原因</th>
