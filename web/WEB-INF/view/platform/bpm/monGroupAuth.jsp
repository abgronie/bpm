...
function saveAuth(){
	...
	$.post(url,params,function(data){
		if(data.result==1){
			...
			$.ligerDialog.warn(data.message,'提示');
		}
	},"json");
}
						...
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td >
									...
									<br>
									<a class="link roles"  href="javascript:;" onclick="chooseRole(this);">选择</a>
							...
							<tr>
								...
								<td >
									...
									<br>
									<a class="link orgs"  href="javascript:;" onclick="chooseOrg(this);">选择</a>
