...
<div class="panel">
	...
	<div class="panel-body">
		...
		<div style="padding-top:20px;background-color: white;float:left;clear:both;">
			...
			<div id="divTaskContainer" style="margin:0 auto;  position: relative;background:url('${ctx}/bpmImage?processInstanceId=${processInstanceId}&randId=<%=Math.random()%>') no-repeat;width:${shapeMeta.width}px;height:${shapeMeta.height + 200}px;">
				${shapeMeta.xml}
			</div>
		</div>
