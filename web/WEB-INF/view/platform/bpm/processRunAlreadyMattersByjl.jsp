    ...
    <head>
        ...
        <script type="text/javascript">
    			var catKey="<%=GlobalType.CAT_FLOW%>";
     			...
     			leftClickUrl= __ctx+'/platform/bpm/processRun/ByjlList.ht'
         </script> 
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="left" title="流程分类" style="overflow: auto;float:left;width:100%;height:96%;">
             ...
             -->
            <div position="center">
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/processRun/alreadyMattersByjlList.ht"></iframe>
            </div>
        </div>
    </body>
</html>
