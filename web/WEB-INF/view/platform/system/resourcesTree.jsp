...
<script type="text/javascript">
	...
	function loadTree(){
		...
		var url="${ctx}/platform/system/resources/getSystemFirstTreeData.ht";
		var params={systemId:systemId,resId:0};
        ...
        if(node.children == null || node.children == "undefined"){
	        if(node.isParent){  
	            $.ajax({  
	                type: "POST",  
	                async:false,  
	                url: "${ctx}/platform/system/resources/getSystemFirstTreeData.ht",  
	                data:{  
	                	systemId:systemId,resId:node.resId
	                },  
	                dataType:"json",
