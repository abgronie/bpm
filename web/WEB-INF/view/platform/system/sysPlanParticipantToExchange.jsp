	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">日程交流--参与者</span>
			</div>
				...
				<div class="toolBar">
					<div class="group">
						<c:choose>
							...
							<c:otherwise>
								<a class="link back" href="${ctx}/platform/system/sysPlan/participant.ht?currentViweDate=${currentViweDate}"><span></span>返回</a>
							</c:otherwise>
						</c:choose>
			...
			<form id="sysPlanExchange" method="post" action="">
				...
				<table class="table-detail" cellpadding="0" cellspacing="0" border="0">				 
					...
					<tr>
						<th width="20%">内容:</th>
						<td colspan="3">
							<textarea disabled="disabled" rows="30" style="width: 98%;overflow:scroll;" >${sysPlan.description}</textarea>  
						</td>
