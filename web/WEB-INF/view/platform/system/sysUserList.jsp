...
<head>
	...
	function syncUserToWx(){
		var confirmContent="<font color='red'>您确定要同步微信通讯录吗？</font>";
		...
		sync = function(){
			...
			if(len==0){
				...
				successMessage ="同步"+len+"名用户至微信通讯录操作成功！";	
			}
	...
	<div class="panel">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="l-bar-separator"></div>
					<%-- <div class="group">
						<f:a alias="syncToLdap" css="link reload" showNoRight="false" onclick="syncToLdap(this)"><span></span>AD同步</f:a>
					</div> --%>
				</div>	
			</div>
			<div class="panel-search">
					<form id="searchForm" method="post" action="list.ht">
						...
						<ul class="row" style="padding-top:0;">
							<div class="row_date">
		...
		<div class="panel-body">
			    ...
			    <display:table export="true" name="sysUserList" id="sysUserItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
					...
					<display:column title="管理" media="html" style="text-align:center;width:13%;" class="rowOps">
						...
						<c:if test="${cookie.origSwitch==null && sysUserItem.status==1}">
