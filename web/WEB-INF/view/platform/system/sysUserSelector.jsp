...
<div>
	<div>
		<form id="searchForm" method="post" action="${ctx}/platform/system/sysUser/selector.ht" >
			<ul class="row">
				...
				<li>
					<span class="label" >工号:</span><input size="14" type="text" name="Q_account_SL"  class="inputText" style="width:20%;" value="${param['Q_account_SL']}"/>&nbsp;
					<span class="label" >姓名:</span><input size="14" type="text" name="Q_fullname_SL"  class="inputText" style="width:20%;" value="${param['Q_fullname_SL']}"/>&nbsp;
	...
	<display:table  name="sysUserList" id="sysUserItem" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
		...
		<display:column  style="width:50px;" property="account" title="工号" sortable="true" sortName="account"></display:column>
		<display:column  style="width:70px;" property="fullname" title="姓名" sortable="true" sortName="fullname"></display:column>
