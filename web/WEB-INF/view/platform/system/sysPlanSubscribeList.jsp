		...
		<div class="panel-body">
		    ...
		    <display:table name="sysPlanList" id="sysPlan" requestURI="${ctx}/platform/system/sysPlan/subscribeList.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column  title="任务名称" sortable="true" sortName="TASKNAME">
						<a class="link" href="${ctx}/platform/system/sysPlan/subscribeGet.ht?type=subscribeList&id=${sysPlan.id}" style="color:blue;">${sysPlan.taskName}</a> 
				</display:column>
				...
				<display:column title="管理" media="html" style="width:100px;text-align:center" > <!--  class="rowOps" -->
					<a href="${ctx}/platform/system/sysPlan/subscribeGet.ht?type=subscribeList&id=${sysPlan.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
