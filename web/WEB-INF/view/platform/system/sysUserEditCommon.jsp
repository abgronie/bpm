...
<script type="text/javascript">
	...
	function submitForm() {
		...
		if(email == null || email == ""){
			$.ligerDialog.error("请填写邮箱信息");
			return;
		}else {
			var reg = /\w+[@]{1}\w+[.]\w+/;
	  		if (!reg.test(email)){
	    		$("#email").focus();
	    		$.ligerDialog.error("请输入正确的email！");
				return;
	  		}
		}
...
<!-- 						</tr> -->
						...
						<tr>
							...
							<td >
								<input type="text" id="fullname" name="fullname" value="${sysUser.fullname}" style="width:240px !important" class="inputText" />
								<%-- ${sysUser.fullname} --%>
							</td>
						</tr>
						<tr>
