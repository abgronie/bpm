	...
	<div id="defLayout">
			<div position="center" style="height:580px;">
				...
				<iframe id="processRunListFrame" name="processRunListFrame" height="95%"
					...
					src="${ctx}/platform/system/sysPlan/processRunList.ht?isSingle=${isSingle}"></iframe>
			</div>
			
			<div position="right" title="<span><a onclick='javascript:dellAll();' class='link del'>清空 </a><input type='text' class='quick-find' title='查找' style='width:56px;' /></span>" 
