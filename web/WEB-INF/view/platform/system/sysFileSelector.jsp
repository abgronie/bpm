...
<body >
	<div class="panel">
		...
		<div class="panel-search" >
			...
			<ul class="row">
				<li><span class="label">文件名:</span><input type="text" id="fileName" name="Q_fileName_SL" style="width:80px;" maxlength="128" class="inputText" value="${param['Q_fileName_SL']}"/></li> 
				<li><span class="label">扩展名:</span><input type="text" id=ext name="Q_ext_SL" style="width:80px;" maxlength="128" class="inputText" value="${param['Q_ext_SL']}"/></li>
			</form>
		</div>
	</div>
