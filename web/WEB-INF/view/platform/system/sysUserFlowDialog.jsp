	...
	<script type="text/javascript">
		...
		*/
		...
		function load_Rol_Tree(){
			...
			function load_userAccount_Tree(){
				var account = $("#account").val();
				var url="${ctx}/platform/system/sysUser/selector.ht";
				var p="?isSingle=${isSingle}&searchBy=5&account="+account;
				$("#userListFrame").attr("src",url+p);
				setCenterTitle("按工号查找:"+account);
			}
			
			function load_userName_Tree(){
				var userName = $("#userName").val();
				userName = encodeURI(userName);
				var url="${ctx}/platform/system/sysUser/selector.ht";
				var p="?isSingle=${isSingle}&searchBy=5&userName="+userName;
				$("#userListFrame").attr("src",url+p);
				setCenterTitle("按姓名查找:"+userName);
			}
	...
	<div id="defLayout">
		<div id="leftMemu" position="left" title="查询条件<input type='checkbox' id='includSub'/>包含子分类" style="overflow: auto; float: left;width: 100%;height:94%;">
			...
			<div title="按工号查找" style="overflow: hidden;">
				...
				<tr>
					<td>
						<span class="label" style="width:10%;">工号:</span>
					</td>
					<td>
						<input style="width:90%;" id="account" name="account" type="text">
					</td>
					<td>
						<a class="link detail" href="javascript:load_userAccount_Tree();">&ensp;</a>
					</td>
				</tr>
				</table>
			</div>
			...
			<div title="按姓名查找" style="overflow: hidden;">
				...
				<tr>
					<td>
						<span class="label"style="width:10%;">姓名:</span>
					</td>
					<td>
						<input style="width:90%;" id="userName" name="userName" type="text">
					</td>
					<td>
						<a class="link detail" href="javascript:load_userName_Tree();">&ensp;</a>
					</td>
				</tr>
				</table>
			</div>
