...
<body>
		...
		<div class="panel-toolbar" id="pToolbar">
			...
			<c:if test="${canReturn==1}">
				<div class="group">
					<a class="link edit" href="${ctx}/platform/system/sysUser/editCommon.ht" ><span></span>修改信息</a>
				</div>
			</c:if>
			</div>
		</div>
		...
		<div title="基本信息" tabid="userdetail"
			...
			<div class="panel-detail">
				<table class="table-detail" cellpadding="0" cellspacing="0"
					border="0">
					<tr>
						<th width="18%" style="height: 48px !important">头像:</th>
						<td>
							<div class="person_pic_div">
								<p><img src="${ctx}/${pictureLoad}" alt="相片" /></p>
							</div>
						</td>
					</tr>
					<tr>
