...
function ForkConditionWindow(conf){
	var url=__ctx + "/platform/bpm/bpmDefinition/setCondition.ht?deployId="+conf.deployId+"&defId=" + conf.defId +"&nodeId=" + conf.nodeId+"&parentActDefId="+conf.parentActDefId;
