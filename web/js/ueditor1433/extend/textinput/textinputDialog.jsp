...
<script type="text/javascript">
	...
	$(function() {
		...
		dialog.onok = function() {
			...
			if( scope.external.valueFrom.value=="3" && scope.external.subTableIsAutoIdentity=="1"){
				input.attr("ht-identity",scope.external.valueFrom.content);
			}else{
				input.removeAttr("ht-identity");
			}
			...
			<tbody>
				...
				<tr class="valuefrom3" ng-if="external.valueFrom.value=='3'">
					...
					<td colspan="3">
						...
						<label>
							<input ng-model="external.subTableIsAutoIdentity" type="checkbox" ng-true-value="1" ng-false-value="0" />
							子表流水号递增 {{subTableIsAutoIdentity}}
						</label>
					</td>
				</tr>
				<tr class="style_tr">
