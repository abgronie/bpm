...
<script type="text/javascript">
	...
	$(function() {
		...
		if (curElement) {
			...
			var isSingleRecord = $(curElement).attr("ischeckbox");
			if(isSingleRecord)
				$("[name = chkItem]:checkbox").attr("checked", true);
				singleSubRecord($("[name = chkItem]:checkbox"));
			if (funcexp)
	...
	dialog.onok = function() {
		...
		if(isSingleRecord)
			$(curElement).attr("ischeckbox", isSingleRecord);
		else
			$(curElement).removeAttr("ischeckbox");
	};
			...
			<div class="l-tab-links title-div">
				<div style="width: 100%; height: 100%; font-weight: normal; padding-left: 8px;">
					...
					<label style="margin-left: 8px;">
						<input type="checkbox" name="chkItem" onclick="singleSubRecord(this)" />
						子表中单条记录运算
					</label>
				</div>
			</div>
