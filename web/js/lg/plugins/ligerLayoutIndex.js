    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            if ($("> div[position=left]", g.layout).length > 0)
            {
                ...
                g.left.header = $('<div class="l-layout-header"><div class="l-layout-header-toggle"></div><div class="menu_up_down" title="展开菜单" onclick="treeExpandAll(true)"></div><div class="menu_up_up" title="收起菜单" onclick="treeExpandAll(false)"></div><div class="l-layout-header-inner"></div></div>');
            ...
            g.leftCollapse = $('<div class="l-layout-collapse-left" style="display: none; left:0px"><div class="l-layout-collapse-left-toggle"></div></div>');
