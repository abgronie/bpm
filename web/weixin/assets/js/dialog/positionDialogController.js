var base = angular.module("positionDialog", ["base"]);
base.controller('PositionController', ['$scope','baseService', function(scope,baseService){
	...
	scope.reload = function(isSearch,treeNode){
		...
		var url=__ctx+'/weixin/orgDialog/positionList.ht';
